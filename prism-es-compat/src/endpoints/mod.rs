...
pub use document::{
    count_handler, delete_doc_handler, delete_index_handler, get_doc_handler, get_index_handler, get_search_handler, head_doc_handler,
...
pub use msearch::msearch_handler_indexed;
pub use search::{async_search_handler, create_pit_handler, delete_pit_handler, search_handler};
